"""Gapminder demo demonstrating how to combine to extend a HoloViews plot with
custom bokeh widgets to deploy an app."""
...
slider = pn.widgets.IntSlider(
    start=int(start), end=int(end), value=int(start), name="Year"
)
