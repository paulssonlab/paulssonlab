        ...
        for t in range(0, len(sizes)):
            if t == 0:
                ...
                for j in range(N_detect):
                    ...
                    neg_Aki = list(Aki[t]["ki"].get(j - 1, {}).values()) + list(
                        Aki[t]["ki"].get(j, {}).values()
                    )
                    neg_Ai = Ai[(j, t)]

                    prob += (
                        lpSum(neg_Aij) + lpSum(neg_Aik) + lpSum(neg_Aki) + neg_Ai <= 1,
                ...
                for j in range(N_detect_f):
                    ...
                    pos_Aik = list(Aik[t - 1]["ki"].get(j - 1, {}).values()) + list(
                        Aik[t - 1]["ki"].get(j, {}).values()
                    )
                    ...
                    prob += (
                        lpSum(pos_Aij) + lpSum(pos_Aik) + lpSum(pos_Aki) <= 1,
                    ...
                    if j >= i:
                        if j in valid_posij_slice:
                            Aij_arr_list[t][i, j] = bool(
                                np.round(Aij[t]["ij"][i][j].varValue)
                            )
                        ...
                        if j < num_j - 1:
                            ...
                            if j in valid_posik_slice:
                                Aik_arr_list[t][i, j] = bool(
                                    np.round(Aik[t]["ik"][i][j].varValue)
                                )
                        ...
                        if i < num_i - 1:
                            ...
                            if j in valid_poski_slice:
                                Aki_arr_list[t][i, j] = bool(
                                    np.round(Aki[t]["ki"][i][j].varValue)
                                )
