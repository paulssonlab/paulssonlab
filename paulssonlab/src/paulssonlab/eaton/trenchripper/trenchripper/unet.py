...
class UNet_Training_DataLoader:
    ...
    def export_chunk(
        self, selectionname, file_idx, augment, file_trench_indices, weight_grid_list
    ):
...
class UNet_Segmenter:
    def __init__(
        self, headpath, modeldbpath
    ):  # ,min_obj_size=20):#,cell_threshold_scaling=1.,border_threshold_scaling=1.,\
